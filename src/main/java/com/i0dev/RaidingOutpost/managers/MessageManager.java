...
public class MessageManager extends AbstractManager {
    ...
    public String pair(String msg, Pair<String, String>... pairs) {
        msg = msg.replace("{prefix}", heart.msg().getPrefix());
    ...
    @SafeVarargs
    public final String everything(String msg, Pair<String, String>... pairs) {
        return color(papi(null, pair(msg, pairs)));
    }
    ...
    @SafeVarargs
    public final void msgAll(String msg, Pair<String, String>... pairs) {
        Bukkit.getOnlinePlayers().forEach(player -> player.sendMessage(color(papi(player, pair(msg, pairs)))));
    }

    @SafeVarargs
    public final void msgAll(Collection<String> msg, Pair<String, String>... pairs) {
